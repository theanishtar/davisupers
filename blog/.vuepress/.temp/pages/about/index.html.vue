...
<ul>
<li>Front-end framework là môn học sử dụng AngularJS để lấy các API</li>
<li>Nội dung <a href="">Assignment</a> là thiết kế một website làm trắc nghiệm onlin và <a href="">Frog Quiz</a> ra đời từ đây...</li>
<li>Vì trong thời gian ngắn nên mình đã hoàn thành nó không được trọn vẹn lắm, nhưng với hơn 1 tháng thì từng ấy là rất tốt đối với mình</li>
<li>Tính năng nâng cao: kết nối Firebase, bình luận bằng tài khoản GitHub...</li>
<li>Các bạn có thể đọc tại <a href="https://caodang.fpt.edu.vn/tin-tuc-poly/can-tho-tin-sinh-vien/nam-sinh-fpt-polytechnic-can-tho-tai-nang-sang-tao-he-thong-hoc-lap-trinh-bo-ich.html?fbclid=IwAR3G-CHLOW5ot3GL64bRN8nAai-yfs1cJNNKmqSZ6AIzm3I4EenWiM671Sw" target="_blank" rel="noopener noreferrer">đây</a></li>
</ul>
<h3 id="lap-trinh-java-5" tabindex="-1"><a class="header-anchor" href="#lap-trinh-java-5" aria-hidden="true">#</a> Lập trình Java 5</h3>
<img src="https://github.com/dangtranhuu/images/blob/main/news/java5.png?raw=true" title="" alt="06-00-18-00-html5.gif" width="800">
<ul>
<li>
<p>Lập trình Java là môn học về Spring Framework sử dụng mô hình MVC (Spring/JSP), mình cùng các bạn trong nnhóm đã lập trình một mạng xã hội chia sẽ đồ <a href="">2hand</a> trực tuyến với sự hướng dẫn của thầy <a href="">Trần Văn Nhuộm</a>.</p>
</li>
<li>
<p>Sử dụng Socket.io để kết nối các client</p>
</li>
<li>
<p>Dự án được sự đánh giá tốt từ các giảng viên!</p>
</li>
<li>
<p>Tính năng nâng cao: Socket.io để xây dựng các luồng nhắn tin, bình luận realtime</p>
</li>
<li>
<p>Các bạn có thể đọc tại <a href="https://caodang.fpt.edu.vn/tin-tuc-poly/can-tho-tin-sinh-vien/dien-dan-truc-tuyen-tang-do-secondhand-tien-loi-made-by-sinh-vien-fpt-polytechnic-can-tho.html?fbclid=IwAR1yLQRKHgKFUbSbXKjZB6JR67aN7obXNf5nKSWTtE-20mhoiaofnfWVJAY" target="_blank" rel="noopener noreferrer">đây</a></p>
</li>
</ul>
...
<p>Vì mình là một sinh viên có học lực rất yếu, hiểu được sự khó khăn của sinh viên khi học CNTT thế nên mình đã xây dựng Blog này để chia sẽ mọi kiến thức mình biết (sẽ cố gắng nhiều nhất có thể).</p>
<!-- 
...
<h2 id="lien-he-voi-minh-nhu-the-nao" tabindex="-1"><a class="header-anchor" href="#lien-he-voi-minh-nhu-the-nao" aria-hidden="true">#</a> Liên hệ với mình như thế nào?</h2>
    ...
    <LinkCard
      ...
      image=""
      siteDomain="true"
      ><p>Linkedin của mình</p>
</LinkCard>

    <LinkCard
      title="dangtt135@gmail.com"
      link=""
      icon="fa-envelope"
      image=""
      siteDomain="true"
